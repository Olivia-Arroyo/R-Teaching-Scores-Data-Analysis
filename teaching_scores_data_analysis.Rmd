---
title: "Teaching Scores Data Analysis"
...
The positive slope of the regression line demonstrates a positive relationship, as instructors have a higher beauty score they also receive higher evaluations.
```{r}
...
The negative slope of the regression line demonstrates a negative relationship, as the age decreases they also receive lower evaluations.
```{r}
